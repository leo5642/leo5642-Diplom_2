...
class LocatorsCollector:
    button_header = (By.XPATH, ".//button[text()='Конструктор']")
    button_lenta_order = (By.XPATH, ".//button[text()='Лента Заказов']")
    button_ingridient = (By.XPATH, ".//button[text()='Флюоресцентная булка R2-D3']")
    text_ingridient = (By.XPATH, ".//button[text()='Детали ингредиента']")
    button_close_text_ingridient = (By.CLASS_NAME, "Modal_modal__close_modified__3V5XS Modal_modal__close__TnseK")
